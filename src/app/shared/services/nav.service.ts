...
export class NavService implements OnDestroy {
	...
	MENUITEMS: Menu[] = [
		...
		{
			title: 'Dashboard', icon: 'dashboard', path: '/dashboard', type:'link', 
		},

		{
			title: 'Clinic List', icon: 'clinicList', path: '/clinic-list', type:'link', 
		},

		{
			title: 'Create Clinic', icon: 'createClinic',  path: '/create-clinic', type:'link', 
		},

		{
			title: 'Report', icon: 'report', path: '/report', type:'link', 
		},

		{
			title: 'Admin Console', icon: 'adminConsol', type: 'sub', badgeType: 'success', children: [
				{ path: 'admin-consol/usermanagement', icon: 'userManagement', title: 'User Management', type: 'link' },
				{  icon: 'master', title: 'Master', type: 'link' }
			]
		},
	...
	MEGAMENUITEMS: Menu[] = [
		...
		},
		{
			title: 'Email templates', type: 'sub', active: false, children: [
				{ path: 'http://admin.pixelstrap.com/VitalScop/theme/basic-template.html', title: 'Basic Email', type: 'extTabLink' },
				{ path: 'http://admin.pixelstrap.com/VitalScop/theme/email-header.html', title: 'Basic With Header', type: 'extTabLink' },
				{ path: 'http://admin.pixelstrap.com/VitalScop/theme/template-email.html', title: 'Ecomerce Template', type: 'extTabLink' },
				{ path: 'http://admin.pixelstrap.com/VitalScop/theme/template-email-2.html', title: 'Email Template 2', type: 'extTabLink' },
				{ path: 'http://admin.pixelstrap.com/VitalScop/theme/ecommerce-templates.html', title: 'Ecommerce Email', type: 'extTabLink' },
				{ path: 'http://admin.pixelstrap.com/VitalScop/theme/email-order-success.html', title: 'Order Success', type: 'extTabLink' }
			]
		},
		{
